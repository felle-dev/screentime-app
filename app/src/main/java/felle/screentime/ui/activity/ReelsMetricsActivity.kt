...
import felle.screentime.databinding.ReelsUsageMetricsBinding
...
import felle.screentime.views.CustomMarkerView
import java.io.File
...
class ReelsMetricsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.shareStats.setOnClickListener {
            binding.btnDigiWelbeing.text = "Tracked Using screentime"
